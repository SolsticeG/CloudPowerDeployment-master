...
public class ConstantsExamples {
    ...
    public static final double SCHEDULING_INTERVAL = 30.0D;
    ...
    public static final int[] HOST_MIPS = new int[]{74548, 37274, 37274};
    public static final int[] HOST_PES = new int[]{16, 8, 16};
    public static final int[] HOST_RAM = new int[]{262144, 131072, 262144};
