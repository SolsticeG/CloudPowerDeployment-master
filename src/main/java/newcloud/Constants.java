...
public class Constants {
    ...
    public static final double SCHEDULING_INTERVAL = 3000.0D;
    public static final double SIMULATION_LIMIT = 6000.0D;
...
//   public static final int[] HOST_RAM = new int[]{4 * 1024, 16 * 1024, 64 * 1024};
    ...
    public static final int NUMBER_OF_HOSTS = 8;

    public static final int terminateTime = 6000;

    public static final int outputTime = 6000;


    public static String inputFolder = "C:\\Users\\gxq\\Desktop\\Cloudsim-DQN-master\\CloudPowerDeployment-master\\src\\main\\resources\\datas\\200";
